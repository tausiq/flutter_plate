            ...
            SingleChildScrollView(
              ...
              child: Padding(
                ...
                child: Row(
                  children: <Widget>[
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/3.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/4.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/5.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/2.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/1.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/6.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/7.jpg',
                    ),
                    new PersonStatus(
                      personImg: 'https://randomuser.me/api/portraits/women/8.jpg',
                    ),
                  ],
                ),
              ),
                      ...
                      child: Row(
                        children: <Widget>[
                          Padding(
                            ...
                            child: CircleAvatar(
                              backgroundImage: NetworkImage('https://randomuser.me/api/portraits/women/13.jpg'),
                            ),
                          ),
                          Expanded(
                            child: Row(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                        ...
                        child: Row(
                          children: <Widget>[
                            Padding(
                              padding: const EdgeInsets.only(right: 8.0),
                              child: CircleAvatar(
                                backgroundImage: NetworkImage('https://randomuser.me/api/portraits/women/14.jpg'),
                              ),
                            ),
                            Expanded(
                              child: Row(
                      ...
                      Image.network('https://image.shutterstock.com/image-photo/gentoo-penguin-walking-on-beach-600w-306427430.jpg'),
                      SizedBox(height: 6.0),
                      Text(
                        'Emperior Penguin',
                        style: TextStyle(
                      ...
                      child: Row(
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.only(right: 8.0),
                            child: CircleAvatar(
                              backgroundImage: NetworkImage('https://randomuser.me/api/portraits/women/15.jpg'),
                            ),
                          ),
                          Expanded(
                            child: Row(
