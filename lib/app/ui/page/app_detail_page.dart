...
class AppDetailPage extends StatefulWidget {
  ...
  AppDetailPage(
      {Key key, this.appId, this.title, this.url, this.heroTag, this.titleTag})
      : super(key: key);
...
class _AppDetailPageState extends State<AppDetailPage> {
  ...
  Widget buildGallerySection(BuildContext context, AppContent appContent) {
    int length = null != appContent.screenshotUrls
        ? appContent.screenshotUrls.length
        : 0;
  ...
  Widget buildSummarySection(BuildContext context, AppContent appContent) {
    String description =
        null != appContent.description ? appContent.description : '';
