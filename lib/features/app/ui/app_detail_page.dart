...
import 'package:flutter_plate/features/app/bloc/app_detail_bloc.dart';
...
class AppDetailPage extends StatefulWidget {
  ...
  AppDetailPage({Key key, this.appId, this.title, this.url, this.heroTag, this.titleTag})
      : super(key: key);

  static String generatePath(
      num appId, String heroTag, String titleTag, String title, String url) {
...
class _AppDetailPageState extends State<AppDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return Scaffold(
              appBar: AppBar(title: Text(appContent.trackName)),
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        margin: EdgeInsets.only(top: 8), child: Text(tr('dialogLoading')))
                  ],
                ))));
  }
        ...
        child: Row(
          ...
          children: <Widget>[
            Container(
                ...
                child: Hero(
                    tag: widget.heroTag, child: buildAppIcon(appContent.artworkUrl100))),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  ...
                  Wrap(direction: Axis.horizontal, spacing: 8, children: chips),
                ],
              ),
            )
          ],
  ...
  Widget buildRatingSection(BuildContext context, AppContent appContent) {
    num userRatingCount =
        null != appContent.userRatingCount ? appContent.userRatingCount : 0;
    num averageUserRating =
        null != appContent.averageUserRating ? appContent.averageUserRating : 0;
  ...
  Widget buildSummarySection(BuildContext context, AppContent appContent) {
    ...
    return Container(padding: EdgeInsets.all(12), child: Text(description));
  }
