...
import 'package:flutter_plate/features/app/bloc/app_store_bloc.dart';
...
class _AppStorePageState extends State<AppStorePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBar(title: buildSearchBar()), body: buildFeedList());
  }
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                      ...
                      margin: EdgeInsets.only(
                          left: 16,
                          right: index == featureListItem.entryList.length - 1 ? 16 : 0),
                      child: InkWell(
                          onTap: () {
        ...
        Container(
            ...
            child: InkWell(
                onTap: () {
                  AppProvider.getRouter(context).navigateTo(
                      context,
                      AppDetailPage.generatePath(
                          app.trackId, heroTag, titleTag, name, app.artworkUrl100),
                      transition: TransitionType.fadeIn);
                },
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        width: 70,
                        child: Hero(
                            tag: heroTag, child: buildAppIcon(index, app.artworkUrl100))),
                    Expanded(
                        child: Container(
